...
<html>
<head>
<title>Health Care Consultation System- Login</title>
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
 ...
 <tr> 
  <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="20">
    <tr> 
     <td class="contentArea"> <form method="GET" name="frmLogin" id="frmLogin">
       <p>&nbsp;</p>
       <table width="350" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#336699" class="entryTable">
        ...
        <tr> 
		 ...
		 <div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
		  ...
		  <table width="100%" height="80%"border="0" cellpadding="2" cellspacing="1" class="text">
           <tr align="center"> 
            <td colspan="3">&nbsp;</td>
           </tr>
           <tr class="text"> 
           ...
           <tr >
                <td></td><td></td><td>
            <img src="captcha.php" alt="Image created by a PHP script" width="160" height="40"> &nbsp <input type="text" placeholder="Enter Captcha" name="cap">
            </td>
           </tr>
           ...
           <tr>
             <td colspan="2">&nbsp;</td>
             <td><div align="right">New Patient <a href="register.php">Register Here</a> </div></td>
           </tr>
           <tr>
