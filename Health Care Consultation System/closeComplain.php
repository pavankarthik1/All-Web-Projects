  ...
  <tr>
    <td class="contentArea"><div class="errorMessage" align="center"></div>
      ...
      <tr class="entryTable">
          ...
          <tr class="entryTable">
            <td valign="top" class="label">&nbsp;Issue Description .</td>
            <td class="content">
      ...
      <tr>
            <td valign="top" class="label">&nbsp;Doctor Name</td>
            <td class="content"><font color="#0033FF"><?php echo $eng_name; ?></font></td>
          </tr>
          
      <tr>
            <td valign="top" class="label">&nbsp;Prescription</td>
            <td class="content">
      ...
      <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input name="btnLogin" type="submit" id="btnLogin" value=" Close Issue "  style="color:#FF0000;font-weight:bold;padding:10px;font-size:14px;"></td>
          </tr>
      </table></td>
  </tr>
</table>
